...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Mon Mar 11 14:56:41 CST 2024
  */
public class CompilerC extends java_cup.runtime.lr_parser {
  ...
  protected static final short _production_table[][] = 
    ...
    "\004\000\002\004\010\000\002\005\004\000\002\006\007" +
    "\000\002\007\005" });
  ...
  protected static final short[][] _action_table = 
    unpackFromStrings(new String[] {
    "\000\027\000\004\014\006\001\002\000\004\026\012\001" +
    ...
    "\016\001\002\000\004\061\026\001\002\000\004\057\025" +
    "\001\002\000\004\031\022\001\002\000\004\057\ufffd\001" +
    "\002\000\004\052\023\001\002\000\004\126\024\001\002" +
    "\000\004\057\ufffb\001\002\000\004\002\ufffe\001\002\000" +
    "\004\054\027\001\002\000\004\062\030\001\002\000\004" +
    "\126\031\001\002\000\004\031\ufffc\001\002" });
  ...
  protected static final short[][] _reduce_table = 
    unpackFromStrings(new String[] {
    "\000\027\000\006\002\004\003\003\001\001\000\004\004" +
  ...
  public final java_cup.runtime.Symbol CUP$CompilerC$do_action(
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$CompilerC$act_num)
        {
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 6: // RETURNS ::= RETURN INTS PUNTO_COMA 
            {
              Object RESULT =null;
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 5: // PRINTFS ::= PRINTF PARENTHESES_LEFT STRINGS PARENTHESES_RIGHT PUNTO_COMA 
            {
              Object RESULT =null;
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 4: // data_main ::= PRINTFS RETURNS 
            {
              Object RESULT =null;

              CUP$CompilerC$result = parser.getSymbolFactory().newSymbol("data_main",3, ((java_cup.runtime.Symbol)CUP$CompilerC$stack.elementAt(CUP$CompilerC$top-1)), ((java_cup.runtime.Symbol)CUP$CompilerC$stack.peek()), RESULT);
            }
          return CUP$CompilerC$result;

          /*. . . . . . . . . . . . . . . . . . . .*/
          case 3: // dec_main ::= INT MAIN LLAMADA_A_FUNCION BRACKET_LEFT data_main BRACKET_RIGHT 
            {
              Object RESULT =null;

              CUP$CompilerC$result = parser.getSymbolFactory().newSymbol("dec_main",2, ((java_cup.runtime.Symbol)CUP$CompilerC$stack.elementAt(CUP$CompilerC$top-5)), ((java_cup.runtime.Symbol)CUP$CompilerC$stack.peek()), RESULT);
            }
          return CUP$CompilerC$result;
